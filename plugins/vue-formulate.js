...
Vue.use(VueFormulate, {
  ...
  classes: {
    outer: 'mb-4',
    element ({ type }) {
      if (type === 'checkbox') { return 'inline-block' }
    },
    input (context) {
      let style =
        'px-3 py-2 rounded border-2 border-blue-500 bg-blue-100 leading-none placeholder-opacity-100 placeholder-blue-800'
    ...
    decorator ({ type }) {
      if (type === 'checkbox') { return 'checkbox-decorator' } else { return 'radio-decorator' }
    },
